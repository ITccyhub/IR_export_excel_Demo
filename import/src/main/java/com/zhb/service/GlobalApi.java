...
//                " },\n" +
                returnIsshowDateTime(returnTimeContformat(returnMap(fileName,"12c6")),returnMap(fileName,"13c6"),"udf_date_31")+    //小陈专业时间处理
...
//                " },\n" +
                returnIsshowDateTime(returnTimeContformat(returnMap(fileName,"20c19")),returnMap(fileName,"20c30"),"udf_date_28")+    //小陈专业时间处理
